          ...
          <div className="row ">
            <div className="col-md-4 stretch-card grid-margin"  >
              <div className="card bg-gradient-info card-img-holder text-white">
                <div className="card-body">
                  ...
                  <h4 className="font-weight-normal mb-3">Total Users<i className="mdi mdi-account-multiple mdi-36px float-right" />
                  </h4>
            ...
            <div className="col-md-4 stretch-card grid-margin">
              <div className="card bg-gradient-info card-img-holder text-white">
                <div className="card-body">
                  <img src="/assets/images/circle.png" className="card-img-absolute" alt="circle-image" />
                  <h4 className="font-weight-normal mb-3">Total Patients<i className="mdi mdi-account mdi-36px float-right" />
                  </h4>
                  <h2 className="mb-5">{dashboardData?.users}</h2>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 stretch-card grid-margin">
              <div className="card bg-gradient-info card-img-holder text-white">
                <div className="card-body">
                  <img src="/assets/images/circle.png" className="card-img-absolute" alt="circle-image" />
                  <h4 className="font-weight-normal mb-3">Total Therapists<i className="mdi mdi-account mdi-36px float-right" />
                  </h4>
                  <h2 className="mb-5">{dashboardData?.therapists}</h2>
                </div>
              </div>
            </div>
